...
| `account_age_days` | Antigüedad de la cuenta | días | Cuántos días llevaba abierta la cuenta cuando llegó la compra. Sale de `users.created_at`, un dato que la tienda ya tiene sin pedirle nada al cliente. Quien entra a defraudar suele estrenar cuenta y quien compra de verdad lleva meses, pero el solapamiento es grande: una tienda joven tiene muchos clientes nuevos y honestos. |
